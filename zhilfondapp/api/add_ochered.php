...
mysqli_query($conn,'START TRANSACTION;');
	...
	$sqls="INSERT INTO `ochered_1` (`id`, `nomer`, `iin`, `fam`, `im`, `ot`, `data`, `cat`) VALUES (NULL, '".$response1[$s][0]."', '".$response1[$s][1]."', '".$response1[$s][2]."', '".$response1[$s][3]."', '".$response1[$s][4]."', '".$response1[$s][5]."', '".$response1[$s][6]."'); ";	
...
mysqli_query($conn,'START TRANSACTION;');
	...
	for ($s = 0; $s<count($response1); $s++){
	$sqls="INSERT INTO `ochered_2` (`id`, `nomer`, `iin`, `fam`, `im`, `ot`, `data`, `cat`) VALUES (NULL, '".$response1[$s][0]."', '".$response1[$s][1]."', '".$response1[$s][2]."', '".$response1[$s][3]."', '".$response1[$s][4]."', '".$response1[$s][5]."', '".$response1[$s][6]."'); ";	
	mysqli_query($conn, $sqls);	
    }
...
mysqli_query($conn,'START TRANSACTION;');
	...
	for ($s = 0; $s<count($response1); $s++){
	$sqls="INSERT INTO `ochered_3` (`id`, `nomer`, `iin`, `fam`, `im`, `ot`, `data`, `cat`) VALUES (NULL, '".$response1[$s][0]."', '".$response1[$s][1]."', '".$response1[$s][2]."', '".$response1[$s][3]."', '".$response1[$s][4]."', '".$response1[$s][5]."', '".$response1[$s][6]."'); ";	
	mysqli_query($conn, $sqls);	
    }
...
mysqli_query($conn,'START TRANSACTION;');
	...
	for ($s = 0; $s<count($response1); $s++){
	$sqls="INSERT INTO `ochered_4` (`id`, `nomer`, `iin`, `fam`, `im`, `ot`, `data`, `cat`) VALUES (NULL, '".$response1[$s][0]."', '".$response1[$s][1]."', '".$response1[$s][2]."', '".$response1[$s][3]."', '".$response1[$s][4]."', '".$response1[$s][5]."', '".$response1[$s][6]."'); ";	
	mysqli_query($conn, $sqls);	
    }
...
mysqli_query($conn,'START TRANSACTION;');
	...
	for ($s = 0; $s<count($response1); $s++){
	$sqls="INSERT INTO `ochered_5` (`id`, `nomer`, `iin`, `fam`, `im`, `ot`, `data`, `cat`) VALUES (NULL, '".$response1[$s][0]."', '".$response1[$s][1]."', '".$response1[$s][2]."', '".$response1[$s][3]."', '".$response1[$s][4]."', '".$response1[$s][5]."', '".$response1[$s][6]."'); ";	
	mysqli_query($conn, $sqls);	
    }
...
mysqli_query($conn,'START TRANSACTION;');
	...
	for ($s = 0; $s<count($response1); $s++){
	$sqls="INSERT INTO `ochered_6` (`id`, `nomer`, `iin`, `fam`, `im`, `ot`, `data`, `cat`) VALUES (NULL, '".$response1[$s][0]."', '".$response1[$s][1]."', '".$response1[$s][2]."', '".$response1[$s][3]."', '".$response1[$s][4]."', '".$response1[$s][5]."', '".$response1[$s][6]."'); ";	
	mysqli_query($conn, $sqls);	
    }
